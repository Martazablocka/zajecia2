...
summary(kraje)
str(kraje)
#6. mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
#7. filter() – wybieranie wierszy ----
#8. select() – wybieranie kolumn ----
...
#10. group_by() – grupowanie ----
#11. summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
